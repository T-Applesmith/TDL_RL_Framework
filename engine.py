    ...
    while not tdl.event.is_window_closed():
        ...
        if move and GameStates.TARGETING:
            if target_reticle_index and entities[target_reticle_index]:
                ...
                if game_map.fov[destination_x, destination_y]:
                    ...
                    targeting_structure = Cone(player.x, player.y, entity.x, entity.y, angle=3)
                    fov_recompute = True
        ...
        for player_turn_result in player_turn_results:
            ...
            if targeting:
                ...
                targeting_structure = Cone(player.x, player.y, target_reticle.x, target_reticle.y, angle=3)
